...
function FormLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${baseUrl}/participante/login`, {
                method: 'POST',
                headers: {
                ...
                <div className='formArea'>
                    <div className="relative mb-4">
                        ...
                        <input
                            ...
                            className="border border-gray-300 text-sm p-2 rounded-md w-full outline-none focus:border-secondary focus-visible:shadow-none"
                        />
                    ...
                    <div className="flex justify-between mb-10">
                        <label className="flex items-center">
                            ...
                            />
                            <span className="opacity-60">Lembrar de mim</span>
                        </label>

                        <button
                            type="button"
                            className="text-sm underline opacity-60 transition hover:opacity-75"
                    ...
                    {
                        errors && (
                            <div onClick={()=> setErrors('')} className="cursor-pointer -mt-4 mb-6">
                    ...
                    <div className="flex flex-col gap-4 md:gap-8 mb-5 md:flex-row justify-between items-center">
                        <Link
                            to="/participantes/cadastro"
                            className="w-full md:w-7/12 cursor-pointer rounded-lg border-2 border-secondary bg-black bg-opacity-0 p-2 text-xl text-center uppercase transition hover:bg-opacity-15"
                        >
                            Criar minha conta
                        </Link>

                        <button
                            className='formButton w-full md:w-7/12'>
                            {!loading ? (
                                'Entrar'
                            ) : (
